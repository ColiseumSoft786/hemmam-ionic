...
var ChallengePage = /** @class */ (function () {
    function ChallengePage(mediaCapture, chooser, platform, navParams, transfer, file, camera, menuCtrl, navCtrl, http, loadingCtrl, toastCtrl) {
        ...
        if (localStorage.getItem("user") === null) {
            ...
            loader_1.present();
            this.http.get('http://api.hemam.online/tasksssss', { params: fetch }).map(function (res) { return res.json(); }).catch(function (error) { return __WEBPACK_IMPORTED_MODULE_9_rxjs__["Observable"].create(error.json()); }).subscribe(function (fetchdata) {
                var fresult = fetchdata;
                _this.fetchdata = fetchdata;
    ...
    ChallengePage.prototype.changephoto = function () {
        ...
        camera.getPicture(function (imageData) {
            ...
            _this.upload(1);
            _this.selected = 'Video has been selected';
